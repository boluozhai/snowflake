...
JS
		.module(function(mc) {
			...
			mc.package('snowflake.encoding.base64.impl');

			var self = this;

			function Base64Implementation() {
			}

			mc.class(function(cc) {
				cc.type(Base64Implementation);
			});

			Base64Implementation.prototype = {
			...
			(function(global) {
				...
				var cb_utob = function(c) {
					if (c.length < 2) {
						...
						var cc = 65536 + (c.charCodeAt(0) - 55296) * 1024
				...
				var cb_encode = function(ccc) {
					var padlen = [ 0, 2, 1 ][ccc.length % 3], ord = ccc
							.charCodeAt(0) << 16
				...
				var _encode = buffer ? function(u) {
					return (u.constructor === buffer.constructor ? u
							: new buffer(u)).toString("base64")
				} : function(u) {
					return btoa(utob(u))
				};
				var encode = function(u, urisafe) {
					return !urisafe ? _encode(String(u)) : _encode(String(u))
				...
				var re_btou = new RegExp([ "[À-ß][-¿]", "[à-ï][-¿]{2}",
						"[ð-÷][-¿]{3}" ].join("|"), "g");
				var cb_btou = function(cccc) {
					...
					case 4:
						var cp = (7 & cccc.charCodeAt(0)) << 18
								...
								| (63 & cccc.charCodeAt(2)) << 6 | 63
								& cccc.charCodeAt(3), offset = cp - 65536;
						return fromCharCode((offset >>> 10) + 55296)
								+ fromCharCode((offset & 1023) + 56320);
					case 3:
						return fromCharCode((15 & cccc.charCodeAt(0)) << 12
								| (63 & cccc.charCodeAt(1)) << 6 | 63
								& cccc.charCodeAt(2));
					default:
						return fromCharCode((31 & cccc.charCodeAt(0)) << 6 | 63
								& cccc.charCodeAt(1))
					}
				};
				var btou = function(b) {
				...
				var cb_decode = function(cccc) {
					var len = cccc.length, padlen = len % 4, n = (len > 0 ? b64tab[cccc
							.charAt(0)] << 18
							: 0)
							...
							fromCharCode(n >>> 16),
							fromCharCode(n >>> 8 & 255), fromCharCode(n & 255) ];
				...
				var _decode = buffer ? function(a) {
					return (a.constructor === buffer.constructor ? a
...
JS.module(function(mc) {
	...
	mc.package('snowflake.encoding.base64');

	var Object = mc.import('js.lang.Object');
	var Class = mc.import('js.lang.Class');
	var Attributes = mc.import('js.lang.Attributes');
	var Base64Impl = mc
			.import('snowflake.encoding.base64.impl.Base64Implementation');

	var impl = new Base64Impl();
	...
	Base64.encode = function(data) {
		var b64 = new Base64();
		return b64.encodeText(data);
	};

	Base64.decode = function(data) {
		var b64 = new Base64();
		return b64.decodeText(data);
	};
